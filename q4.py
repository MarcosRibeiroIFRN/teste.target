...
# RESPOSTA:
# # Na primeira ida aperto os interruptores 1 e 2 e na segunda ida aperto os interruptores 2 e 3, assim o que se repetir nas duas idas será o segundo e os que mudarão
# respectivamente serão 1 e 3